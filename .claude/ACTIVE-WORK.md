...
|---|---|---|---|
| C-20260812-1930-detection-split | 2026-08-12 19:45 | CV review of `docs/ARCHITECTURE.md`; split the tiling-detection risk into two non-colliding experiments for Adarsh | Wrote `docs/FACE-DETECTION-EXPERIMENTS.md` (Idea A: calibrated fixed-grid tiling vs Idea B: multi-scale coarse-to-fine detection) and scaffolded `experiments/tiled-grid-detection/` + `experiments/multiscale-pyramid-detection/` with README stubs only — no implementation yet, each folder owned by whoever claims it here first. · `docs/FACE-DETECTION-EXPERIMENTS.md`, `experiments/tiled-grid-detection/README.md`, `experiments/multiscale-pyramid-detection/README.md` |
